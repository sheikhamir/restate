...
@section('title', 'Ahuse - Administrator Login')
    ...
    <div class="row noMarginRow">
        <div class="col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-4 col-lg-offset-4">
            <div class="login-form">
                <h1 class="text-center">{{ __('Administrator Login') }}</h1>
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="row noMarginRow input-container">
                        <div class="col-sm-12">
                            ...
                            @else
                                <div class="alert alert-normal">If you are a user, <a href="{{ route('login') }}">click here</a>.</div>
                            @endif
                        </div>
                    </div>
                    <div class="row noMarginRow input-container">
